...
generation for a specific payroll provider's report format. Adding a new
client = new module here (or reuse an existing format runner with a
different config).
"""
...
from payroll_clients.square_payroll          import run_square_payroll
